...
def non_iid_partition(dataset, num_clients=10, alpha=15.0):
    num_classes = 10
...
def train_client(model, dataloader, epochs=5, lr=0.001):
    ...
    optimizer = optim.SGD(model.parameters(), lr=lr, momentum=0.9, weight_decay=1e-4)  #  Adds weight decay
...
num_rounds = 7
num_clients_per_round = 10  # Select subset of clients each round
